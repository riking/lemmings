...
#    Updated: 2017/05/04 14:57:26 by kyork            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
COMMONSRC	+= search/search_print_path.c search/search_path_room_queue.c search/search_work_path.c search/search_workall.c search/search_setup.c
...
COMMONSRC	+= parse/parse_rooms.c parse/parse_layout.c parse/parse_set_startfinish.c
